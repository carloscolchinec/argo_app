...
use App\Models\CnDailyConsumption;
...
class RegistroConsumoX24 extends Command
{
    protected $signature = 'consumo-diario:registrar';
    ...
    public function handle()
    {
        ...
        foreach ($users as $user) {
            ...
            if ($routerData) {
                ...
                $consumoDiario = new CnTbConsumoDiario();
